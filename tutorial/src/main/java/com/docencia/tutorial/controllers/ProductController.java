...
public class ProductController {
    ...
    private static final List<Map<String, String>> products = new ArrayList<>(List.of(
        Map.of("id", "1", "name", "TV", "description", "Best TV", "price", "650$"),
        Map.of("id", "2", "name", "iPhone", "description", "Best iPhone", "price", "725$"),
        Map.of("id", "3", "name", "Chromecast", "description", "Best Chromecast", "price", "110$"),
        Map.of("id", "4", "name", "Glasses", "description", "Best Glasses", "price", "35$")
    ));
    ...
    public String about(Model model) {
        model.addAttribute("title", "Successfull");
    ...
    public String save(@Valid @ModelAttribute("productForm") ProductForm productForm, BindingResult result, Model model) {
        ...
        // Simulación de guardar el producto en la lista
